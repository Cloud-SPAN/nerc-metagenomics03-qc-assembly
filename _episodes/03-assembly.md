...
> If you are interested you can explore the repeat graph created by Flye. This is entirely optional as not every assembler will generate a repeat graph and usually metagenomic repeat graphs are are large and complicated so don't tell you much.
...
> In order to do this we need to install a program called Bandage onto your local computer. You can download this from the [Bandage Website](https://rrwick.github.io/Bandage/) by selecting your operating system down the side.  
...
>> # Bandage output of this assembly
